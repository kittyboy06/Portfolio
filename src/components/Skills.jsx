...
import { Cpu, Smartphone, Globe, Gamepad2, Brain, Wrench, CheckCircle2 } from 'lucide-react'
          ...
          {categories.map((category) => {
            ...
            return (
              <motion.div 
                ...
                className="glass glass-hover p-6 rounded-3xl border border-white/15 shadow-xl flex flex-col h-full justify-between"
              >
                <div>
                  {/* Category Header */}
