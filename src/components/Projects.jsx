          ...
          {projectsData.map((project) => {
            ...
            if (isFeatured) {
              return (
                ...
                >
                  {/* Featured Card */}
                  <div className="group glass glass-hover relative flex flex-col justify-between h-full rounded-3xl border border-white/15 p-6 md:p-8 shadow-xl overflow-hidden">
                    {/* Status Badge */}
                    <span 
            ...
            return (
              <motion.div 
                ...
                className="h-full"
              >
                <div className="group glass glass-hover relative flex flex-col justify-between h-full rounded-3xl border border-white/15 p-6 shadow-xl overflow-hidden">
                  {/* Status Badge */}
                  <span 
